...
H,S0,S1,S2,T,Nbins,q_vals,scattering_array = DiagMC(N=1000000,A10 = 0.2,A12 = 0.4,A21 = 0.4,q0=90,D0=1,deltaq=0.0001,lam=1.5,potential=-1.3,r_star=1,mass=1,Niterations = 1000, eps = epsilon, big = K)
...
analytical_scattering_length = a_analytical(potential = 1.3,r_star = 1, mass = 1)
