...
# ================================ ALGORITHM ================================
@njit
def DiagMC(N,A10,A12,A21,q0,D0,deltaq,lam,potential,r_star,mass, Niterations = 100, eps = epsilon,big=K_big):
    '''
...
scat3 = []
for Zpot in potlist:
    H,S0,S1,S2,T,Nbins,q_vals,scattering_array = DiagMC(N=1000000,A10 = 0.2,A12 = 0.4,A21 = 0.4,q0=20,D0=1,deltaq=0.0001,lam=1.5,potential=Zpot,r_star=1,mass=1,Niterations = 2, eps = epsilon, big = K_big)
...
plt.plot(V_0 ,scattering_length,color = 'red',label = 'Numerov')


ax.scatter(potlist ,scatter_length_num,color = 'k',s=40,label = 'BDMC')
